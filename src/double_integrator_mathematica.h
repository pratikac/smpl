...
#define mt121 (-(2*u121*u211*(dx2f*u121*u211 + dx1f*pow(u211,2) + sqrt(2)*u121*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))) + \
              sqrt(2)*sqrt(u121*pow(u211,3)*(3*pow(dx2f,2)*pow(u121,2)*(u121 + u121)*u211 + 2*dx2f*u121*(u121 + u121)*(dx1f*pow(u211,2) + sqrt(2)*u121*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))) + \
              u211*(pow(dx1f,2)*(3*u121 - u121)*pow(u211,2) + 4*u121*u211*((-u121 + u121)*u211*x1f + u121*(u121 + u121)*x2f) + \
              2*sqrt(2)*dx1f*u121*(u121 + u121)*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))))))/(2.*u121*(u121 - u121)*pow(u211,3)), \
              (-2*u121*u211*(dx2f*u121*u211 + dx1f*pow(u211,2) + sqrt(2)*u121*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))) + \
              sqrt(2)*sqrt(u121*pow(u211,3)*(3*pow(dx2f,2)*pow(u121,2)*(u121 + u121)*u211 + 2*dx2f*u121*(u121 + u121)*(dx1f*pow(u211,2) + sqrt(2)*u121*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))) +  \
              u211*(pow(dx1f,2)*(3*u121 - u121)*pow(u211,2) + 4*u121*u211*((-u121 + u121)*u211*x1f + u121*(u121 + u121)*x2f) + \
              2*sqrt(2)*dx1f*u121*(u121 + u121)*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))))))/(2.*u121*(u121 - u121)*pow(u211,3)))

#define mt122 (-((3*u121 - u121)*u211*(dx2f*u121*u211 + dx1f*pow(u211,2) + sqrt(2)*u121*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))) + \
              sqrt(2)*sqrt(u121*pow(u211,3)*(3*pow(dx2f,2)*pow(u121,2)*(u121 + u121)*u211 + 2*dx2f*u121*(u121 + u121)*(dx1f*pow(u211,2) + sqrt(2)*u121*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))) + \
              u211*(pow(dx1f,2)*(3*u121 - u121)*pow(u211,2) + 4*u121*u211*((-u121 + u121)*u211*x1f + u121*(u121 + u121)*x2f) + \
              2*sqrt(2)*dx1f*u121*(u121 + u121)*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))))))/(2.*u121*(u121 - u121)*pow(u211,3)),\
              (-((3*u121 - u121)*u211*(dx2f*u121*u211 + dx1f*pow(u211,2) + sqrt(2)*u121*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f)))) + \
              sqrt(2)*sqrt(u121*pow(u211,3)*(3*pow(dx2f,2)*pow(u121,2)*(u121 + u121)*u211 + 2*dx2f*u121*(u121 + u121)*(dx1f*pow(u211,2) + sqrt(2)*u121*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))) + \
              u211*(pow(dx1f,2)*(3*u121 - u121)*pow(u211,2) + 4*u121*u211*((-u121 + u121)*u211*x1f + u121*(u121 + u121)*x2f) + \
              2*sqrt(2)*dx1f*u121*(u121 + u121)*sqrt(pow(u211,2)*(pow(dx2f,2) + 2*u211*x2f))))))/(2.*u121*(u121 - u121)*pow(u211,3)))
