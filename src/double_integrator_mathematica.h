...
#define mdt1l1(g)   (-2*dx10*um - (2*pow(dx10,2)*g*pow(um,2) - \
                    6*pow(g,2)*pow(um,3)*x10)/ \
                    (sqrt(2)*sqrt(pow(dx10,2)*pow(g,2)*pow(um,2) - \
                                2*pow(g,3)*pow(um,3)*x10)))/(2.*pow(g,2)*pow(um,2)) - \
                                   (-2*dx10*g*um - sqrt(2)*sqrt(pow(dx10,2)*pow(g,2)*pow(um,2) - \
                                                                         2*pow(g,3)*pow(um,3)*x10))/(pow(g,3)*pow(um,2))

#define mt1l2(g)    (-2*dx10*g*um + sqrt(2)*sqrt(pow(dx10,2)*pow(g*um,2) - \
                    2*pow(g*um,3)*x10))/(2.*pow(g*um,2))


#define mdt1l2(g)    (-2*dx10*um + (2*pow(dx10,2)*g*pow(um,2) - \
                    6*pow(g,2)*pow(um,3)*x10)/ \
                    (sqrt(2)*sqrt(pow(dx10,2)*pow(g,2)*pow(um,2) - \
                    2*pow(g,3)*pow(um,3)*x10)))/(2.*pow(g,2)*pow(um,2)) - \
                    (-2*dx10*g*um + sqrt(2)*sqrt(pow(dx10,2)*pow(g,2)*pow(um,2) - \
...
#define mdt2l(g)    (-x10/(2.*pow(g,2)*um) - \
                    (pow(dx10,2) - 2*g*um*x10)/(2.*pow(g,3)*pow(um,2)))
