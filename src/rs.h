...
/***********************************************************/
double reeds_shepp(double x1, double y1, double t1, double x2, double y2, double t2,
...
/***********************************************************/
double min_length_rs(double x1, double y1, double t1, double x2, double y2, double t2,
    int* numero, double* t, double* u, double* v)
{
  ...
  else length_rs = reeds_shepp(x1,y1,t1,x2,y2,t2,numero,t,u,v);
...
/***********************************************************/
int fct_curve(int ty, int orientation, double val, double* x1, double* y1, double* t1,
    double delta,
...
/***********************************************************/
int constRS(int num, double t, double u, double v, double x1, double y1, double t1,
    double delta,
